...
def gen_data_and_vocab(path, vocab_path, train_raw_path, test_raw_path):
...
def prepare_data():
    ...
    train_raw_path = '../datasets/w2v/20news_train_raw.txt'
    test_raw_path = '../datasets/w2v/20news_test_raw.txt'
